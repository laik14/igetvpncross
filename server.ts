...
// Серверные узлы WireGuard (Mock серверы)
const SERVER_NODES = [
  {
    id: "de-fra-1",
    name: "Frankfurt #1 (High Speed)",
    city: "Frankfurt",
    country: "Germany",
    countryCode: "DE",
    flag: "🇩🇪",
    endpoint: "fra1.wireguard-proxy.net:51820",
    serverPublicKey: "c2VydmVyX2dlcm1hbnlfcHVibGljX2tleV9mcmFuazE=",
    ip: "185.220.101.42",
    dns: "1.1.1.1, 1.0.0.1",
  ...
  {
    id: "nl-ams-1",
    name: "Amsterdam #2 (P2P / No Logs)",
    city: "Amsterdam",
    country: "Netherlands",
    countryCode: "NL",
    flag: "🇳🇱",
    endpoint: "ams2.wireguard-proxy.net:51820",
    serverPublicKey: "c2VydmVyX25ldGhlcmxhbmRzX3B1YmxpY19rZXk=",
    ip: "194.104.28.15",
    dns: "1.1.1.1, 8.8.8.8",
  ...
  {
    id: "us-nyc-1",
    name: "New York #1 (Streaming Optimized)",
    city: "New York",
    country: "United States",
    countryCode: "US",
    flag: "🇺🇸",
    endpoint: "nyc1.wireguard-proxy.net:51820",
    serverPublicKey: "c2VydmVyX3VzYV9uZ3ljX3B1YmxpY19rZXk1MTg=",
    ip: "104.28.19.88",
    dns: "8.8.8.8, 8.8.4.4",
    protocol: "WireGuard Standard (UDP)",
    obfuscated: false,
  ...
  {
    id: "jp-tyo-1",
    name: "Tokyo #1 (Asia Ultra Gateway)",
    city: "Tokyo",
    country: "Japan",
    countryCode: "JP",
    flag: "🇯🇵",
    endpoint: "tyo1.wireguard-proxy.net:51820",
    serverPublicKey: "c2VydmVyX2phcGFuX3R5bzFfcHVibGljX2tleQ==",
    ip: "160.16.210.5",
    dns: "1.1.1.1, 9.9.9.9",
    protocol: "WireGuard over WS/TLS",
    obfuscated: true,
    pingMs: 142,
    loadPercent: 28,
    supportsIPv6: true,
  ...
  {
    id: "fi-hel-1",
    name: "Helsinki #1 (Privacy Haven)",
    city: "Helsinki",
    country: "Finland",
    countryCode: "FI",
    flag: "🇫🇮",
    endpoint: "hel1.wireguard-proxy.net:51820",
    serverPublicKey: "c2VydmVyX2ZpbmxhbmRfaGVsMV9wdWJsaWNfa2V5",
    ip: "95.216.140.11",
  ...
  {
    id: "sg-sin-1",
    name: "Singapore #1 (Fast Routing)",
    city: "Singapore",
    country: "Singapore",
    countryCode: "SG",
    flag: "🇸🇬",
    endpoint: "sin1.wireguard-proxy.net:51820",
    serverPublicKey: "c2VydmVyX3NpbmdhcG9yZV9zaW4xX3B1YmxpYw==",
    ip: "128.199.200.77",
    dns: "1.1.1.1, 1.0.0.1",
    protocol: "WireGuard Standard (UDP)",
    obfuscated: false,
  ...
  {
    id: "ch-zur-1",
    name: "Zurich #1 (Swiss Secure Vault)",
    city: "Zurich",
    country: "Switzerland",
    countryCode: "CH",
    flag: "🇨🇭",
    endpoint: "zur1.wireguard-proxy.net:51820",
    serverPublicKey: "c2VydmVyX3N3aXR6ZXJsYW5kX3p1cjFfcHVibGlj",
    ip: "179.43.148.9",
    dns: "10.2.0.1 (No-Log Quad9)",
    protocol: "WireGuard Standard (UDP)",
    obfuscated: false,
    pingMs: 22,
    loadPercent: 14,
